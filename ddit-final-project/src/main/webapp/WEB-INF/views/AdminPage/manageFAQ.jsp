	...
	<div class="container">
		<div class="mb-6" style=" height:20px;">
			<ul class="nav nav-tabs destination-tabs" id="destinationTab" role="tablist">
				<li class="nav-item">
					<a class="nav-link" id="overView-tab" href='<%=request.getContextPath()%>/mypage/admin/manageNotice'>공지사항</a>
				</li>
				<li class="nav-item">
					<a class="nav-link active" id="tourGuide-tab" href='<%=request.getContextPath()%>/mypage/admin/manageFAQ'>자주 묻는 질문</a>
				</li>
<!-- 					<li class="nav-item"> -->
