							...
							<div class="col-lg-12">
								<div class="form-group">
									<form:select path="artBCode"
										...
										aria-label=".form-select-lg example" hidden = "hidden" id="bcode">
										<option value="${article['artBCode'] }" selected>여행지 질문게시판</option>
									</form:select>
								</div>
							</div>
							<div class="col-lg-12">
								<div class="form-group">
									<form:select path="artCCode"
										class="form-select form-select-lg mb-3"
										aria-label=".form-select-lg example" hidden="hidden" id="ccode">
										<option value="${article['artCCode'] }" selected>파리</option>
									</form:select>
								</div>
							</div>
						<div class="col-lg-12">
