		...
		<div class="mb-6">
			<ul class="list-unstyled d-md-flex bg-smoke mb-0 p-5 px-lg-6 rounded" id="list">
				<li class="mb-4 mb-md-0 px-md-3">
					<a href="${pageContext.request.contextPath }/article/serviceList/BC003" class="text-uppercase text-dark hover-text-primary">공지사항</a> 
				 </li>
				<li class="mb-4 mb-md-0 px-md-3">
					<a href="${pageContext.request.contextPath }/article/serviceList/BC005" class="text-uppercase text-dark hover-text-primary">자주묻는 질문</a>
				</li>
			</ul>
		</div>
...
<script type="text/javascript">
	...
	let makeTrTag = function(article) {
		...
		let aTag = $("<a>").attr("href",
				"${pageContext.request.contextPath}/article/service/" + article.artNum)
				.text(article.artTitle);

		tr
				.append( $("<td style='padding-left: 5px;' class='col-1'>") .html(article.artNum),
						$( "<td style='padding-left: 5px; text-align: center;' class='col-6'>") .html(aTag),
						$( "<td style='padding-left: 5px; text-align: center;' class='col-1'>") .html(article.artHit),
						$( "<td style='padding-left: 5px; text-align: center;' class='col-2'>") .html("관리자"),
						$( "<td style='padding-left: 5px; text-align: center;' class='col-2'>") .html(article.artDate));
		return tr;
	}
