	...
	<div class="container clearfix">
		<div id="menuzord" class="menuzord">
			<a href="${pageContext.request.contextPath }/" class="menuzord-brand">
            	<img class="lazyestload" data-src="${pageContext.request.contextPath }/resources/images/logo-color-big.png" src="${pageContext.request.contextPath }/resources/images/logo-color-big.png" alt="logo-img">
          	</a>
			<ul class="menuzord-menu menuzord-right" style="width: 630px;">
				...
				<li class=""><a href="javascript:void(0)">상품</a>
					<ul class="dropdown drop-up">
						<li class="">
							<a href="${pageContext.request.contextPath }/prod/packageList">패키지</a>
						</li>
						<li class="">
							<a href="${pageContext.request.contextPath }/prod/hotelList">호텔</a>
						</li>
						<li class="">
							<a href="${pageContext.request.contextPath }/prod/rentcarList">렌터카</a>
						<li class="">
							<a href="${pageContext.request.contextPath }/insurance/iForm">보험</a>
						</li>
					</ul></li>
				...
				<li class="">
					<a href="${pageContext.request.contextPath }/blog/blogMainPage">블로그</a>
					<ul class="dropdown drop-up">
						<li class="">
