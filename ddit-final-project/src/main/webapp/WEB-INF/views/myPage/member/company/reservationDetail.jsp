						...
						<div class="col-lg-6">
							<div class="page-title-content">
								<div class="title-border">
									<h2 class="text-uppercase text-white font-weight-bold">예약 내역 조회</h2>
								</div>
						...
						<div class="row">
							<div>
								<img
									...
									src="${reservation.prodImg }" alt="상품이미지">
							</div>
							...
							<div class="col-lg-6">
								<div class="form-group">
									<label for="inputName">이름</label> <input type="text"
										class="form-control border-0 bg-smoke"
										value="${resDetail.rdeFnam}">
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group">
									<label for="inputName">성</label> <input type="text"
										class="form-control border-0 bg-smoke"
										value="${resDetail.rdeLnam}">
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group">
					...
					<div class="card-footer mt-6">
						<h2 class="mb-0">
							...
							<span class="text-primary font-weight-bold">
								&#8361;<fmt:formatNumber value="${reservation.prodPrice}" pattern="#,###" />
							</span>
						</h2>
					</div>
				</div>
