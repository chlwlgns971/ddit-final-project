								...
								<div class="col-md-6 col-xl-4 mb-5">
									<div class="card card-hover">
										<a href="single-package-right-sidebar.html"
											...
											data-src="${pageContext.request.contextPath }/resources/images/home/deal/deal-01.jpg"
											src="${pageContext.request.contextPath }/resources/images/home/deal/deal-01.jpg"
											alt="Card image cap">
											<div
										...
										<div class="card-body px-4">
											<a href="single-package-right-sidebar.html"
												class="card-title text-uppercase">A 축제</a>
											</h5>
											<p class="mb-5">A 축제</p>
											<div
								...
								<div class="col-md-6 col-xl-4 mb-5">
									<div class="card card-hover">
										...
										<div class="card-body px-4">
											<h5 class="">
												<a href="single-package-right-sidebar.html"
													class="card-title text-uppercase">B 축제</a>
											</h5>
											<p class="mb-5">B 축제.</p>
											<div
												class="d-flex justify-content-between align-items-center">
								...
								<div class="col-md-6 col-xl-4 mb-5">
									<div class="card card-hover">
										...
										<div class="card-body px-4">
											<h5>
												<a href="single-package-right-sidebar.html"
													class="card-title text-uppercase">C 축제</a>
											</h5>
											<p class="mb-5">C 축제.</p>
											<div
												class="d-flex justify-content-between align-items-center">
								...
								<div class="col-md-6 col-xl-4 mb-5">
									<div class="card card-hover">
										...
										<div class="card-body px-4">
											<h5 class="">
												<a href="single-package-right-sidebar.html"
													class="card-title text-uppercase">D 축제</a>
											</h5>
								...
								<div class="col-md-6 col-xl-4 mb-5">
									<div class="card card-hover">
										...
										<div class="card-body px-4">
											<h5 class="">
												<a href="single-package-right-sidebar.html"
													class="card-title text-uppercase">E 축제</a>
											</h5>
								...
								<div class="col-md-6 col-xl-4 mb-5">
									<div class="card card-hover">
										...
										<div class="card-body px-4">
											<h5>
												<a href="single-package-right-sidebar.html"
													class="card-title text-uppercase">F 축제</a>
											</h5>
											<p class="mb-5">F 축제.</p>
